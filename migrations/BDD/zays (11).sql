...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 15 jan. 2024 à 15:14
...
INSERT INTO `appartement` (`id`, `description`, `surface_habitable`, `immeuble_id`, `porte`, `surface_sol`, `situation`, `num_compteur`) VALUES
(57, '', 15.11, 1, 1, 15.11, 'Rez de chaussée', 0),
(58, '', 20, 1, 2, 20, 'Rez de chaussée', 0),
(59, '', 21, 1, 3, 21, 'Cour extérieure', 0),
(60, '', 20, 1, 4, 20, 'Cour extérieure', 0),
(61, '', 18.86, 1, 5, 18.86, '1er étage', 0),
(62, '', 25, 1, 6, 25, '2eme étage', 0),
(63, '', 14.31, 1, 7, 14.31, '3eme étage', 0);
...
(28, '2024-01-10', 400, 200, 400, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 60, 3, 200, NULL, 'TheWooKI', NULL, 0, NULL, NULL, NULL),
...
(36, '2024-01-01', 350, 350, 400, NULL, NULL, '2024-01-30', '6', NULL, NULL, NULL, NULL, 59, NULL, 350, NULL, 'vfxg', NULL, 0, 9000, NULL, NULL);
...
(35, 'Mr', 'Douglas', '2024-01-10', 'Gotham', NULL, 0, 'douglas@gmail.com', 750659586, NULL),
(42, 'Langlais', 'Luna', '2002-01-11', 'caen', NULL, 1, 'luna.langlais@gmail.com', 231235645, NULL),
(43, 'LANGLAIS', 'LUNA', '2024-01-11', 'cccc', NULL, 0, 'cccc@ccc.com', 214584758, NULL);
...
(91, 'Appartement 3 - LANGLAIS LUNA', 1, 36),
(92, 'Dépôt garantie 3 - LANGLAIS LUNA', 2, 36),
(93, 'Restitution dépôt garantie 3 - LANGLAIS LUNA', 2, 36);
...
INSERT INTO `user` (`id`, `nom`, `prenom`, `email`, `password`, `roles`, `is_verified`, `associe_id`) VALUES
(6, 'Lonardino', 'Mickael', 'mickael@hotmail.com', '$2y$13$DMp9ifF9lfI3qmsnvom86.Vh5/WzTtOphtDRfwDGlyaLcGQ0q49eG', '[\"ROLE_ASSOCIE\"]', 0, 3),
(9, 'super', 'admin', 'superadmin@zays.com', '$2y$13$zhUjkA6VWwa/hNIpxcJQte7b/fRW3GCNKO9DSZpQo5gjX.7DvmMsW', '[\"ROLE_ADMIN\"]', 0, NULL);
