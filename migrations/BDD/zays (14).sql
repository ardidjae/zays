...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 25 jan. 2024 à 15:37
...
INSERT INTO `appartement` (`id`, `description`, `surface_habitable`, `immeuble_id`, `porte`, `surface_sol`, `situation`, `num_compteur`, `image`) VALUES
(57, '', 15.11, 1, 1, 15.11, 'Rez de chaussée', 0, 'Test1-Image-65b10a7181dd9.jpg'),
(58, '', 20, 1, 2, 20, 'Rez de chaussée', 0, 'Test1-Image-65b0f94ea4dca.jpg'),
(59, '', 21, 1, 3, 21, 'Cour extérieure', 0, 'Test-Image-65b02a4960d49.jpg'),
(60, '', 20, 1, 4, 20, 'Cour extérieure', 0, 'Test-Image-65b02af7e70e8.jpg'),
(61, '', 18.86, 1, 5, 18.86, '1er étage', 0, 'Test-Image-65b035b7c2a81.jpg'),
(62, '', 25, 1, 6, 25, '2eme étage', 0, 'Test-Image-65b0d6a8b2fbe.jpg'),
(63, '', 14.31, 1, 7, 14.31, '3eme étage', 0, 'Test2-Image-65b238abc3ede.jpg');
...
(1, '2022-08-01', 290, 30, 290, 'M. Antony Carpentier, père de Zoé Carpentier', 'Mme Séverien Carpentier, mère de Zoé Carpentier', '2024-11-01', '6', NULL, 'azerty', 'azerty', 'attestation-caf-al-v2-20231114-205201-511-92-65ae4132a4777.pdf', 57, 3, 320, 0, '2024', 'azerty', 0, 0, '', ''),
...
(17, '2024-01-08', 400, 200, 400, '', '', '2030-08-30', '6', '', '', '', '', 61, NULL, 200, 600, 'thewoo', '', 1, 0, '', ''),
(18, '2024-01-09', 400, 200, 500, '', '', '0000-00-00', '', '', '', '', '', 57, NULL, 200, 0, 'THEWOO', '', 0, 0, '', ''),
(28, '2024-01-10', 400, 200, 400, NULL, NULL, '2024-01-20', NULL, NULL, NULL, NULL, NULL, 60, 3, 200, 600, 'TheWooKI', NULL, 1, NULL, NULL, NULL),
(33, '2024-01-11', 400, 200, 400, NULL, NULL, '2023-01-31', NULL, NULL, '...', '...', NULL, 62, 3, 200, 600, 'TheJohann', NULL, 1, 0, NULL, NULL),
(35, '2024-01-01', 350, 30, 350, NULL, NULL, '2024-01-15', NULL, NULL, 'hkjhk', 'gdfg', NULL, 59, 3, 0, 380, '2023', NULL, 1, 350, NULL, NULL),
(36, '2024-01-01', 350, 350, 400, NULL, NULL, '2024-01-30', '6', NULL, NULL, NULL, NULL, 59, NULL, 350, 700, 'vfxg', NULL, 1, 9000, NULL, NULL),
(84, '2024-01-01', 1, 1, 1, NULL, NULL, '2024-01-30', NULL, NULL, NULL, NULL, NULL, 57, 3, 1, 2, '1', NULL, 1, NULL, NULL, NULL),
(88, '2024-01-25', 100, 100, 100, NULL, NULL, '2024-01-31', NULL, NULL, NULL, NULL, NULL, 63, NULL, 100, 200, '2023', NULL, 1, NULL, NULL, NULL),
(91, '2024-01-18', 100, 100, 100, NULL, NULL, '2024-01-24', NULL, 'CV-DJAE-Ardelaide-65ae366d4b329.pdf', NULL, NULL, 'Attestation-sur-l-honneur-65ae3e628da95.pdf', 57, NULL, 100, 200, '2023', NULL, 1, NULL, 'avis-echeance-20220622-170546-158-13-20231106-212212-644-72-65ae3a152ea2a.pdf', 'CV-DJAE-Ardelaide-Ancien-CV-65ae3e266f36f.pdf'),
(92, '2024-01-26', 100, 100, 100, NULL, NULL, '2024-01-27', NULL, NULL, NULL, NULL, NULL, 57, NULL, 100, 200, '2023', NULL, 1, NULL, 'CV-DJAE-Ardelaide-65ae3f903b5ba.pdf', 'Pix-guide-65ae64c6f3837.pdf'),
(93, '2024-01-22', 100, 100, 100, NULL, NULL, '2024-01-25', NULL, NULL, NULL, NULL, 'Test-AttestationAssurance-65ae6e37a51ce.pdf', 57, NULL, 100, NULL, '2023', NULL, 0, NULL, 'Test-EtatLieuEntreeSigne-65ae6e16b5ad4.pdf', 'Test-EtatLieuSortieSigne-65ae6e4516bab.pdf'),
(94, '2024-01-22', 300, 100, 100, NULL, NULL, '2024-01-31', NULL, NULL, NULL, NULL, 'Test-AttestationAssurance-65aecd653ac7a.pdf', 57, 3, 200, NULL, '2023', NULL, 0, NULL, NULL, 'Test-EtatLieuSortieSigne-65aed016dbd8c.pdf'),
(95, '2024-01-25', 1, 1, 1, NULL, NULL, '2024-01-28', NULL, NULL, NULL, NULL, NULL, 57, NULL, 1, 2, '1', NULL, 1, NULL, NULL, NULL);
...
('DoctrineMigrations\\Version20240110075045', '2024-01-10 07:51:28', 174),
('DoctrineMigrations\\Version20240110085133', '2024-01-10 08:52:22', 92),
('DoctrineMigrations\\Version20240115130819', '2024-01-15 13:09:19', 171),
('DoctrineMigrations\\Version20240116080953', '2024-01-16 08:10:32', 162),
('DoctrineMigrations\\Version20240119101939', '2024-01-19 10:20:27', 85),
('DoctrineMigrations\\Version20240123141348', '2024-01-23 14:20:47', 128);
...
(2, 'TALIS', 15, 'rue master', 75000, 'Paris', 1);
...
(23, 'Bacar', 'Ize', '2000-11-20', 'Mamoudzou', 0, 1, 'ize@gmail.com', 780625195, ''),
(25, 'ISMAEL', 'Karim', '2010-10-10', 'GOTHAM', 0, 0, 'karim@gmail.com', 722659854, ''),
(35, 'Mr', 'Douglas', '2024-01-10', 'Gotham', NULL, 1, 'douglas@gmail.com', 750659586, NULL),
(42, 'Langlais', 'Luna', '2002-01-11', 'caen', NULL, 1, 'luna.langlais@gmail.com', 231235645, NULL),
(43, 'LANGLAIS', 'LUNA', '2024-01-11', 'cccc', NULL, 1, 'cccc@ccc.com', 214584758, NULL),
(94, '1', '1', '2024-01-01', '1', NULL, 1, '1', 1, 'CV-DJAE-Ardelaide-65ad453617e62.pdf'),
(96, '2', '2', '2024-01-02', '2', NULL, 0, '2', 2, 'SIO2-Certificat-de-scolarite-de-DJAE-Ardelaide-65ada033e9e8a.pdf'),
(98, 'Bacar', 'Kaize', '2024-01-03', 'Mamoudzou', NULL, 1, 'kaize@gmail.com', 759632658, 'SIO2-Certificat-de-scolarite-de-DJAE-Ardelaide-1-65ada53095327.pdf'),
(101, 'Ahamadi', 'Iraf', '2024-01-06', 'Mamoudzou', NULL, 1, 'iraf@gmail.com', 795869587, 'CV-Kaiza-65ae311f50605.pdf'),
(102, 'Is', 'Johann', '2024-01-22', 'Gabon', NULL, 1, 'is@gmail.com', 785963258, 'SIO1-Certificat-de-scolarite-Ardelaide-65ae3ec87a6eb.pdf'),
(103, 'Brigite', 'Nael', '2024-01-13', 'Gabon', NULL, 0, 'nael@gmail.com', 785962658, 'Test-PieceJustificative-65ae6cb0c1b4a.pdf'),
(104, 'Martin', 'Sophie', '2024-01-22', 'Lyon', NULL, 0, 'sophie@mt.com', 751268695, 'Test-PieceJustificative-65aecca4e30de.pdf'),
(105, '1', '1', '2024-01-25', '1', NULL, 1, '1', 1, 'Test-PieceJustificative-65b27abb7660e.pdf');
...
CREATE TABLE IF NOT EXISTS `paiement` (
  ...
  KEY `IDX_B1DC7A1EECD1C222` (`mouvement_id`)
...
INSERT INTO `paiement` (`id`, `date_p`, `montant`, `source`, `bail_id`, `moisannee_id`, `caf`, `mouvement_id`) VALUES
(1, '2024-01-10', 292, '', 1, 1, 28, NULL),
(4, '2024-01-20', 400, '', 2, 1, 20, NULL);
...
(262, 'Appartement 1 - Brigite Nael', 1, 93),
(263, 'Dépôt garantie 1 - Brigite Nael', 2, 93),
(264, 'Restitution dépôt garantie 1 - Brigite Nael', 2, 93),
(265, 'Appartement 1 - Martin Sophie', 1, 94),
(266, 'Dépôt garantie 1 - Martin Sophie', 2, 94),
(267, 'Restitution dépôt garantie 1 - Martin Sophie', 2, 94);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `locataire_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_8D93D649C41A218C` (`associe_id`),
  UNIQUE KEY `UNIQ_8D93D649D8A38199` (`locataire_id`)
...
INSERT INTO `user` (`id`, `nom`, `prenom`, `email`, `password`, `roles`, `is_verified`, `associe_id`, `locataire_id`) VALUES
(6, 'Lonardino', 'Mickael', 'mickael@hotmail.com', '$2y$13$DMp9ifF9lfI3qmsnvom86.Vh5/WzTtOphtDRfwDGlyaLcGQ0q49eG', '[\"ROLE_ASSOCIE\"]', 0, 3, NULL),
(9, 'super', 'admin', 'superadmin@zays.com', '$2y$13$zhUjkA6VWwa/hNIpxcJQte7b/fRW3GCNKO9DSZpQo5gjX.7DvmMsW', '[\"ROLE_ADMIN\"]', 0, NULL, NULL),
(12, 'CARPENTIER', 'Zoé', 'carpentier.zoe@gmail.com', '$2y$13$XATtio/REB0e/TG6NmtMW.YKAxR3nOPO/S92bsLNLmLtGm1rWyZKG', '[\"ROLE_LOCATAIRE\"]', 0, NULL, 1);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_8D93D649C41A218C` FOREIGN KEY (`associe_id`) REFERENCES `associe` (`id`),
  ADD CONSTRAINT `FK_8D93D649D8A38199` FOREIGN KEY (`locataire_id`) REFERENCES `locataire` (`id`);
COMMIT;
