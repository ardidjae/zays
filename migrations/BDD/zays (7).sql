...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 04 jan. 2024 à 11:45
...
CREATE TABLE IF NOT EXISTS `bail` (
  ...
  `nom_caution1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_caution2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_fin` date NOT NULL,
  `duree_bail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `bail_signe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `etat_lieu_entree` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `etat_lieu_sortie` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `attestation_assurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `appartement_id` int DEFAULT NULL,
  `associe_id` int DEFAULT NULL,
  `montant_prem_echeance` double NOT NULL,
  `montant_der_echeance` double NOT NULL,
  `trimestre_reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `piece_justificative` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `archive` int NOT NULL,
  `caution_restituer` double NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `bail` (`id`, `date_debut`, `montant_hc`, `montant_charges`, `montant_caution`, `nom_caution1`, `nom_caution2`, `date_fin`, `duree_bail`, `bail_signe`, `etat_lieu_entree`, `etat_lieu_sortie`, `attestation_assurance`, `appartement_id`, `associe_id`, `montant_prem_echeance`, `montant_der_echeance`, `trimestre_reference`, `piece_justificative`, `archive`, `caution_restituer`) VALUES
...
(2, '2020-09-01', 390, 30, 390, 'Néant', '', '2024-09-01', '6', 'Oui', 'azerty', 'azerty', '', 58, 2, 390, 420, '', '', 0, 0),
(11, '2023-12-16', 582, 282, 252, 'zaaz', 'aza', '2023-12-09', '6', 'Oui', 'reeze', 'zeez', 'ezz', 57, 2, 252, 366, 'zeez', 'ezze', 1, 0),
...
(14, '2023-12-15', 888, 8888, 8888, 'svdfbgdfg', 'fvbfdvdfvf', '2023-12-15', '6', 'Oui', 'erdfghn', 'gbn', 'sdfgvb', 57, 2, 88888, 8888, 'sdfghbn', 'sdfghjk', 1, 0);
...
(1, 'CARPENTIER', 'Zoé', '2004-01-16', 'Lisieux', 0, 0),
(2, 'LECUYER', 'Christine', '1957-06-22', 'Caen', 22, 0),
(3, 'KHASMI', 'Mehdi', '1993-08-06', 'Montivillers', 277, 0),
(4, 'JOACHIM', 'Romane', '2003-09-02', 'Caen', 0, 0),
(5, 'LESSU FALIO', 'Elsa', '1993-10-23', 'Douala (Cameroun)', 0, 0),
(6, 'LAURENT', 'Charlotte', '2004-03-25', 'Coutances', 268, 0),
(7, 'JOUVIN', 'Théo', '2001-12-19', 'Coutances', 118, 0),
(12, 'rerere', 'erreerre', '2023-12-09', 'rereerre', 8528, 0),
(13, 'aaaaa', 'aaaaaa', '2023-12-14', 'aaaaa', 8585, 0),
(14, 'bbbbbbbbb', 'bbbbbbbbb', '2023-12-16', 'bbbbbbbbbb', 777, 0),
(15, 'ooooooo', 'oooooooo', '2023-12-06', 'oooooooooooo', 888, 0),
(16, 'dddddd', 'dddddd', '2023-12-09', 'ddddddd', 555, 0),
(17, 'eeeeee', 'eeee', '2023-12-09', 'eeeeee', 6666, 0);
...
(1, '2022-12-07', 292, '', 1, 1, 28),
(4, '2022-11-07', 400, '', 2, 1, 20);
...
CREATE TABLE IF NOT EXISTS `piece_jointe` (
  ...
  KEY `IDX_AB5111D43E3F1FE8` (`bail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sous_categorie` (`id`, `libelle`, `categorie_id`) VALUES
(1, 'Appartement 1-Carpentier', 1),
(2, 'Appartement 2-Lecuyer', 1),
(3, 'Appartement 3-Khasmi', 1),
(4, 'Appartement 4', 1),
(5, 'Appartement 5-Joachim', 1),
(6, 'Appartement 6-Lessu Falio', 1),
(7, 'Appartement 7-Laurent', 1),
(8, 'Appartement 8-Jouvin', 1),
(9, 'Appartement 1-Carpentier-caf', 1),
(10, 'Appartement 2-Lecuyer-caf', 1),
(11, 'Appartement 3-Khasmi-caf', 1),
(12, 'Appartement 4--caf', 1),
(13, 'Appartement 5-Joachim-caf', 1),
(14, 'Appartement 6-Lessu Fialo-caf', 1),
(15, 'Appartement 7-Laurent-caf', 1),
(16, 'Appartement 8-Jouvin-caf', 1),
(17, 'Versement appartement 1-Carpentier', 2),
(18, 'Versement appartement 2-Lecuyer', 2),
(19, 'Versement appartement 3-Khasmi', 2),
(20, 'Versement appartement 4', 2),
(21, 'Versement appartement 5-Joachim', 2),
(22, 'Versement appartement 6-Lessu Fialo', 2),
(23, 'Versement appartement 7-Laurent', 2),
(24, 'Versement appartement 8-Jouvin', 2),
(41, 'Restitution appartement 1-Carpentier', 2),
(42, 'Restitution appartement 2-Lecuyer', 2),
(43, 'Restitution appartement 3-Khasmi', 2),
(44, 'Restitution appartement 4', 2),
(45, 'Restitution appartement 5-Joachim', 2),
(46, 'Restitution appartement 6-Lessu Fialo', 2),
(47, 'Restitution appartement 7-Laurent', 2),
(48, 'Restitution appartement 8-Jouvin', 2),
(49, 'Remboursement emprunt', 3),
(50, 'Assurance emprunt ', 3),
(51, 'Assurance emprunteur', 4),
(52, 'Habitation', 4),
(53, 'Taxe foncière', 5),
(54, 'Frais bancaires', 6),
(55, 'Autres', 6),
(56, 'Achat matériel, produit', 7),
(57, 'Réparation', 7),
(58, 'Eau', 8),
(59, 'Electricité', 8),
(60, 'Appartement 1', 9),
...
(66, 'Appartement 7', 9),
(67, 'Appartement 8', 9),
(68, 'Parties communes', 9),
(69, 'Ancien locataire-Beullet', 1),
(70, 'Ancien locataire-Dasrot', 1),
(71, 'Restitution caution-Dasrot', 2),
(72, 'Restitution caution-Beullet', 2);
...
(6, 'Lonardino', 'Mickael', 'mickael@hotmail.com', '$2y$13$DMp9ifF9lfI3qmsnvom86.Vh5/WzTtOphtDRfwDGlyaLcGQ0q49eG', '[\"ROLE_ADMIN\"]', 0);
...
ALTER TABLE `piece_jointe`
  ADD CONSTRAINT `FK_AB5111D43E3F1FE8` FOREIGN KEY (`bail_id`) REFERENCES `bail` (`id`),
